							...
							<tbody>
								...
								<tr>
									...
									<td>	
										...
										<a href="awards_update.php?fld_gallery_id=<?php echo $fetch['fld_gallery_id'] ?>" class="fa fa-edit" style="color: green; font-size: 20px"></a>	
									</td>
									...
									<td>
										<a href="assets/images/awards/<?php echo $fetch['fld_gallery_photo'];?>" target="_blank">
										<img src="assets/images/awards/<?php echo $fetch['fld_gallery_photo'];?>" height="75px" width="75px"></a></td>           
