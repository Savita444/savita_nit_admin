			...
			<div class="min-height-200px">
				<div class="page-header">
                  ...
                  <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
									...
									<li class="breadcrumb-item active" aria-current="page">Update Time Table Information</li>
								</ol>
							</nav>
						</div>
               ...
               <a class="btn btn-primary" href="timetableinfo_view.php" role="button">
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					...
					<?php 
                        ...
                        $view=mysqli_query($connect,"select * from timetable where timetable_id='".$_GET['timetable_id']."'") or die(mysqli_error($connect));
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <select name="semister" class="form-control">
                                    ...
                                    <?php
                              $query1=mysqli_query($connect,"select * from timetable where syllabus_delete='0' order by timetable_id desc");
                              while($row=mysqli_fetch_assoc($query1)){
                                extract($row);
                            ?>
                        ...
                        <div class="preview_box">
                                    <?php 
                                        ...
                                        { 
                                    ?>
                                        <img id="preview_img" src="assets/documents/timetable/placeholder.jpg" height="100" width="100" />
                                    <?php 
                                        }
                                        else
                                        {
                                    ...
                                    ?>
                                        <img id="preview_img" src="assets/documents/timetable/<?php echo $fetch['file']?>" height="100" width="100" />
                                    <?php 
...
// error_reporting(0);
    ...
    if(isset($_POST['submit']))
    {
        ...
        $add2=mysqli_query($connect,"update timetable set
        department_id='".$department_id."',
        semister='".$semister."',
        file='".$a."'
        where timetable_id='".$_GET['timetable_id']."'") or die(mysqli_error($connect)); 
            
        $desired_dir="assets/documents/timetable/";
        move_uploaded_file($fileTmpName,"$desired_dir/".$a);

        if($add2)
       {
         echo '<script type="text/javascript">';
         echo " alert('Time Table Update Successfully.');";
         echo 'window.location.href = "timetableinfo_view.php";';
         echo '</script>';
        }
        else
       {
         echo '<script type="text/javascript">';
         echo " alert('Time Table Information Not Added.');";
         echo 'window.location.href = "timetableinfo_view.php";';
         echo '<script>';
       }
    }
