						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item"><a href="#">Staff Download Section</a></li>
							...
							<tbody>
                                ...
                                <tr>
									...
									<td>
                                        ...
                                        <a href="staffdt_delete.php?staff_id=<?php echo $fetch['staff_id'] ?>" onclick="return confirm('Are you sure to Delete Student Download Section Record')" class="fa fa-trash-o"  style="color: red;font-size: 20px;">
                                        </a>
									</td>
