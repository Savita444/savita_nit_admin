        ...
        <div class="page-header">
          <div class="row">
            <div class="col-md-6 col-sm-12">
              ...
              <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="academiccalendar_view.php">Academic Calendar</a></li>
            ...
            <div class="col-md-6 col-sm-12 text-right">
              <div class="dropdown">
                <a class="btn btn-primary" href="add_calendar.php" role="button">
          ...
          <div class="row">
            <table class="stripe hover data-table-export nowrap">
              ...
              <tbody>
                <?php 
                  $count=0; 
                  $query="select * from academiccalendar  where syllabus_delete='0' order by calendar_id desc";
