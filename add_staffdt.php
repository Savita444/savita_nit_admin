                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="title">
                                <h4>Add Staff Download Section</h4>
                            </div>
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                                    <li class="breadcrumb-item">Add Staff Download Section</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="col-md-6 col-sm-12 text-right">
                         <div class="dropdown">
                           <a class="btn btn-primary" href="staff_view.php" role="button">
...
// error_reporting(0);
  ...
  $extension = strtolower(pathinfo($a,PATHINFO_EXTENSION));  
        ...
        if($add2)
       {
         ...
         echo " alert('Staff Download Section Added Successfully.');";
       ...
       {
         echo '<script type="text/javascript">';
         echo " alert('Staff Download Section Not Added.');";
         echo 'window.location.href = "staff_view.php";';
         echo '<script>';
       }
    }
