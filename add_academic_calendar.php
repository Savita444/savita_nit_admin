                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="title">
                                <h4>Add Academic Calendar</h4>
                            </div>
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                                    <li class="breadcrumb-item">Add Academic Calendar</li>
...
// error_reporting(0);
  ...
  $extension = strtolower(pathinfo($a,PATHINFO_EXTENSION));  
               ...
               $query="insert into academic_calendar(academic_title,file) VALUES('$academic_title','$a');";
        ...
        if($add2)
       {
         ...
         echo " alert('Academic Calendar Added Successfully.');";
       ...
       {
         echo '<script type="text/javascript">';
         echo " alert('Academic Calendar Not Added.');";
         echo 'window.location.href = "academic_calendar_view.php";';
         echo '<script>';
       }
    }
