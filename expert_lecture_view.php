				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>View Expert lecture</h4>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
									<li class="breadcrumb-item">View Expert lecture</li>
						...
						<div class="col-md-6 col-sm-12 text-right">
							<div class="dropdown">
								<a class="btn btn-primary" href="add_expert_lecture.php" role="button">
									Add Expert lecture
								</a>
							</div>
						</div>
					...
					<div class="row">
						<table class="stripe hover data-table-export nowrap">
							...
							<tbody>
								<?php 
                                $count=0; 
                                $query="select * from expert_lecture where expert_lecture_delete='0' order by expert_lecture_id desc";
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $fetch['expert_lecture_created_date'];?></td>   
                                </tr>
                                            <?php } ?>
							</tbody>
						</table>
