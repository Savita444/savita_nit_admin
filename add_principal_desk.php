	...
	<div class="main-container">
		<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
            ...
            <div class="col-md-6 col-sm-12 text-right">
              <div class="dropdown">
                <a class="btn btn-primary" href="view_principal_desk.php" role="button">
                  View Principal Desk
                </a>
              </div>
            </div>						
					...
					<form method="post" enctype="multipart/form-data">
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" placeholder="Enter Principal Name" name="principal_name" required="">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Principal Photo<span style="color: red;">*</span></label>
							<div class="col-sm-12 col-md-10">
...
error_reporting(0);
    ...
    if(isset($_POST['submit']))
    {
        ...
        if($add2)
       {
         ...
         echo " alert('Principal Added Successfully.');";
       ...
       {
         echo '<script type="text/javascript">';
         echo " alert('Principal Not Added.');";
         echo 'window.location.href = "add_principal_desk.php";';
         echo '<script>';
       }
    }
?>               
