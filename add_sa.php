	...
	<div class="main-container">
		<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
			<div class="min-height-200px">
              ...
              <div class="col-sm-12 col-md-10">
                <select name="fld_bm_department" class="form-control">
...
<?php
	...
	$query="INSERT INTO tbl_sa_members(fld_bm_name,Designation_id,Department_id) VALUES ('$fld_bm_name','$fld_bm_designation','$fld_bm_department')";
		        
		        $row=mysqli_query($connect,$query) or die(mysqli_error($connect));
		        if ($row) 
		        {
		            echo "<script>";
		            echo "alert('Students Association Members Added Successfully');";
		        ...
		        {
		            echo "<script>";
		            echo "alert('Students Association Members Not Added');";
		            echo "</script>";
		        }
		    }    
    // }
