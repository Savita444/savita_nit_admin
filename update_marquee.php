...
<body>
	...
	<div class="main-container">
		<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
            ...
            <?php 
                $sel=mysqli_query($connect,"select * from tbl_marquee where fld_marquee_id='".$_GET['fld_marquee_id']."'") or die(mysqli_error($connect));
...
//error_reporting(0);
    ...
    if(isset($_POST['update']))
    {
        ...
        $query=mysqli_query($connect,"update tbl_marquee set
                marquee_text='".$marquee_description."'
                where fld_marquee_id='".$_GET['fld_marquee_id']."'") or die(mysqli_error($connect));
        if($query)
       {
