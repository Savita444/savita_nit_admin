        ...
        <div class="page-header">
          <div class="row">
            <div class="col-md-6 col-sm-12">
              <div class="title">
                <h4>View Academics Information</h4>
              </div>
            ...
            <div class="col-md-6 col-sm-12 text-right">
              <div class="dropdown">
                <a class="btn btn-primary" href="add_academics.php" role="button">
                  Add Academics Information
                </a>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <table class="stripe hover data-table-export nowrap">
              ...
              <tbody>
                <?php 
                  $count=0; 
                  $query="select s.*,dp.* from tbl_academics s,academics dp where s.academics_id=dp.academics_id  and s.fld_delete='0' order by s.fld_academics_id desc";
