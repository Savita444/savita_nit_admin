                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="title">
                                <h4>View Grievance Redressal Committee Members </h4>
                            </div>
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                                    <li class="breadcrumb-item">View Grievance Redressal Committee Members</li>
                        ...
                        <div class="col-md-6 col-sm-12 text-right">
                            <div class="dropdown">
                                <a class="btn btn-primary" href="add_redressal.php" role="button">
                                    Add Grievance Redressal Committee
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="stripe hover data-table-export nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="redressal_delete.php?fld_bm_id=<?php echo $fetch['fld_bm_id'] ?>"
                                            onclick="return confirm('Are you sure to Delete Grievance Redressal Committee Members Record')"
                                            class="fa fa-trash-o" style="color: red;font-size: 20px;">
                                        </a>
										<a href="redressal_update.php?fld_bm_id=<?php echo $fetch['fld_bm_id'] ?>"
