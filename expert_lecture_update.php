			...
			<div class="min-height-200px">
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>Update Expert lecture</h4>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
									<li class="breadcrumb-item">Update Expert lecture</li>
								</ol>
							</nav>
						</div>
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
                    ...
                    <?php 
                        ...
                        $view=mysqli_query($connect,"select * from expert_lecture where expert_lecture_id='".$_GET['expert_lecture_id']."'") or die(mysqli_error($connect));
                    ...
                    <div class="form-group row">
                        ...
                        <div class="preview_box">
                                    <?php 
                                        ...
                                        { 
                                    ?>
                                        <img id="preview_img" src="assets/images/expertlecture/placeholder.jpg" height="100" width="100" />
                                    <?php 
                                        }
                                        else
                                        {
                                    ...
                                    ?>
                                        <img id="preview_img" src="assets/images/expertlecture/<?php echo $fetch['file']?>" height="100" width="100" />
                                    <?php 
...
if(isset($_POST['submit']))
{
    ...
    $add2=mysqli_query($connect,"update expert_lecture set
    file='".$a."'
    where expert_lecture_id='".$_GET['expert_lecture_id']."'") or die(mysqli_error($connect)); 
    ...
    if($add2)
   {
     ...
     echo " alert('Expert lecture Update Successfully.');";
   ...
   {
     echo '<script type="text/javascript">';
     echo " alert('Expert lecture Not Update.');";
     echo 'window.location.href = "expert_lecture_view.php";';
     echo '<script>';
   }
}
