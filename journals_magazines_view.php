				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>View Journals and magazines</h4>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
									<li class="breadcrumb-item">View Journals and magazines</li>
						...
						<div class="col-md-6 col-sm-12 text-right">
							<div class="dropdown">
								<a class="btn btn-primary" href="journals_magazines_add.php" role="button">
									Add Journals and magazines
								</a>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<table class="stripe hover data-table-export nowrap">
							...
							<tbody>
								<?php 
                                $count=0; 
                                $query="select * from journals_magazines where fld_delete='0' order by journals_magazines_id desc";
