            ...
            <div class="min-height-200px">
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">Update Achievements and Awards</li>
                ...
                <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
                    ...
                    <form method="post" enctype="multipart/form-data">
                        ...
                        $view=mysqli_query($connect,"select * from tbl_awards where fld_gallery_id='".$_GET['fld_gallery_id']."'") or die(mysqli_error($connect));
						      ...
						      <div class="preview_box">
                                <?php
                                    if($fetch['fld_gallery_photo'] =="")
                                    {
                                        ...
                                        ?>
                                            <img src="assets/images/awards/No-image-full.jpg" alt="" id="preview_img" height="100px" width="100px" />
                                    <?php
                                        }
                                        else
                                        {
...
// error_reporting(0);
    ...
    if(isset($_POST['submit']))
    {
        ...
        $add2=mysqli_query($connect,"update tbl_awards set
