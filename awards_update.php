				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>Update Achievements and Awards</h4>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Update Achievements and Awards</li>
								</ol>
							</nav>
						</div>
...
<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					...
					<form method="post" enctype="multipart/form-data">
		 				  <?php 
                                $sel=mysqli_query($connect,"select * from tbl_awards where fld_gallery_id='".$_GET['fld_gallery_id']."'") or die(mysqli_error($connect));
                        ...
                        <div class="col-sm-12 col-md-10">               
                            ...
                            <?php
                                ...
                                {
                            ?>
                                    <img src="assets/images/awards/No-image-full.jpg" id="preview_img" height="100px" width="100px"/>
                            <?php
                                }
                                else
                                {
                            ?>                                        
                                    <img src="assets/images/awards/<?php echo $fetch['fld_gallery_photo'];?>" id="preview_img" height="100px" width="100px" />
                            <?php
                                }
                            ?>
...
error_reporting(0);
    ...
    $temp=$_FILES['photo']['tmp_name'];
     ...
     $update=mysqli_query($connect,"update tbl_awards set
     ...
     if($update)
           ...
           echo " alert('Achievements and Awards Successfully.');";
           ...
           echo '</script>';
                         ...
                         {
           echo '<script type="text/javascript">';
           echo "alert('Achievements and Awards Not Update.');";
             echo '<script>';
                            //echo $cQry;
