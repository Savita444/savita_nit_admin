				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>View Governing Board Members </h4>
							</div>
						...
						<div class="col-md-6 col-sm-12 text-right">
							<div class="dropdown">
								<a class="btn btn-primary" href="add_gove.php" role="button">
									Add Governing Board Members
								</a>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<table class="stripe hover data-table-export nowrap">
							...
							<tbody>
								<?php 
                                $count=0; 
                                $query="select d.*,b.* from designation d,tbl_board_members b where d.Designation_id=b.Designation_id and d.Designation_delete='0' and b.fld_delete='0' order by b.fld_bm_id desc";
