...
<body>
	...
	<div class="main-container">
		<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>Update Student Implant Training</h4>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
									<li class="breadcrumb-item"><a href="view_student_training.php">Student Implant Training</a></li>
									<li class="breadcrumb-item active" aria-current="page">Update Student Implant Training</li>
								</ol>
							</nav>
						</div>
            ...
            <?php 
                $sel=mysqli_query($connect,"select * from tbl_Student_training where student_id='".$_GET['student_id']."'") or die(mysqli_error($connect));
                $fetch=mysqli_fetch_array($sel);
            ?> 
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Name<span style="color: red;">*</span></label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" placeholder="Enter Name" name="name" value="<?php echo $fetch['student_name']; ?>">
							</div>
						</div>
            ...
            <div class="form-group row">
             ...
             <div class="form-group row">
              ...
              <div class="col-sm-12 col-md-10">
                <textarea class="form-control" name="company" placeholder="Enter Name and Address of Company"><?php echo $fetch['name_of_company'];?></textarea>
              </div>
            </div>
            <!-- <div class="form-group row">
            ...
            <!-- <div class="form-group row">
              ...
              <div class="col-sm-12 col-md-10">
                ...
                <a href="view_student_training.php" class="btn btn-warning">Back</a>
							</div>
						</div>
					</form>
			</div>
...
// error_reporting(0);
    ...
    {
        extract($_POST);
        // $update=mysqli_query($connect,"update tbl_student_training set
        //         student_name ='".$name."',
        //         Department_id ='".$department."',
        //         name_of_company ='".$company."' 
        //         where student_id ='".$_GET['student_id']."'") or die(mysqli_error($connect));
        $UP=mysqli_query($connect,"update tbl_student_training set
        Department_id='".$department."',
        student_name='".$name."',
        name_of_company='".$company."'
        where student_id ='".$_GET['student_id']."'") or die(mysqli_error($connect));
                
       // $add2=mysqli_query($connect,$UP) or die(mysqli_error($connect)); 


        if($UP)
       {
         echo '<script type="text/javascript">';
         echo "alert('Student Implant Training Details Update Successfully.');";
       ...
       {
         echo '<script type="text/javascript">';
         echo "alert('Student Implant Training Details Not Update.');";
         echo 'window.location.href ="update_student_training.php";';
         echo '<script>';
       }
    }
?>               
