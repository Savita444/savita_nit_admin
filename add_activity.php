	...
	<div class="main-container">
		<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
            ...
            <div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<textarea class="textarea_editor form-control border-radius-0" name="activity_description" placeholder="Enter Activity Description"></textarea>
							</div>
						</div>
						...
						<!--	<div class="col-sm-12 col-md-10">-->
						<!--		<textarea class="textarea_editor form-control border-radius-0" name="activity_specification" placeholder="Enter Activity Specification"></textarea>-->
						<!--	</div>-->
						<!--</div>-->
                ...
                <a href="activitiesinfo_view.php" class="btn btn-warning">Back</a>
							</div>
						</div>
					</form>
			</div>
