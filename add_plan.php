	...
	<div class="main-container">
		<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
            ...
            <div class="form-group row">
						...
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Subject Name<span style="color: red;">*</span> : </label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" placeholder="Enter Subject Name" name="subject_name" required="">
							</div>
						</div>
