				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>View Library staff</h4>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
									<li class="breadcrumb-item active" aria-current="page">View Library staff</li>
								</ol>
							</nav>
						</div>
						<div class="col-md-6 col-sm-12 text-right">
							<div class="dropdown">
								<a class="btn btn-primary" href="add_library_staff.php" role="button">
									ADD Library staff
								</a>
							</div>
						</div>
					...
					<div class="row">
						...
						<table class="stripe hover data-table-export nowrap">
							...
							<tbody>
								<?php 
                                    $count=0; 
                                    $query="select * from library_staff where staff_delete='0' order by library_staff_id desc";
								...
								<tr>
									...
									<td>
										<img src="assets/images/librarystaff/<?php echo $fetch['files'];?>" height="75px" width="75px"></a></td>           
