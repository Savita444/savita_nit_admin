                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="title">
                                <h4>Add Fees Regulating Authority</h4>
                            </div>
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                                    <li class="breadcrumb-item">Add Fees Regulating Authority</li>
...
// error_reporting(0);
  ...
  $extension = strtolower(pathinfo($a,PATHINFO_EXTENSION));  
        ...
        if($add2)
       {
         ...
         echo " alert('Fees Regulating Authority Added Successfully.');";
       ...
       {
         echo '<script type="text/javascript">';
         echo " alert('Fees Regulating Authority Not Added.');";
         echo 'window.location.href = "fees_view.php";';
         echo '<script>';
       }
    }
