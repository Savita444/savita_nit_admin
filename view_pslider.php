				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item" ria-current="page">Prize Distribution Slider</li>
						...
						<div class="col-md-6 col-sm-12 text-right">
							<div class="dropdown">
								<a class="btn btn-primary" href="add_pslider.php" role="button">
									Add Slider
								</a>
							</div>
						</div>
					...
					<div class="row">
						<table class="stripe hover data-table-export nowrap">
							...
							<tbody>
								<?php 
                                            $count=0; 
                                            $query="select * from tbl_prize_slider where fld_delete='0' order by fld_pslider_id desc";
                                        ...
                                        ?> 
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="pslider_delete.php?fld_pslider_id=<?php echo $fetch['fld_pslider_id'] ?>" onclick="return confirm('Are you sure to Delete Slider Image')" class="fa fa-trash-o"  style="color: red;font-size: 20px;"></a>
                                                </td> 
                                                ...
                                                <td><?php echo $fetch['prize_slider_modified_date'];?></td>   
                                            </tr>
                                            <?php } ?>
							</tbody>
						</table>
