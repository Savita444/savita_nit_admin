		...
		<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
			<div class="min-height-200px">
				<div class="page-header">
					<div class="row">
						<div class="col-md-8 col-sm-12">
							<div class="title">
								<h4>Update SC/ST Cell</h4>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                  					<li class="breadcrumb-item">Update SC/ST Cell</li>
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					...
					<form method="post">
                        <?php 
							$view=mysqli_query($connect,"select * from tbl_scst_members where fld_bm_id='".$_GET['fld_bm_id']."'") or die(mysqli_error($connect));
...
<?php
    ...
    if (isset($_POST['submit'])) 
    {
        ...
        $add2=mysqli_query($connect,"update tbl_scst_members set
        ...
        where fld_bm_id='".$_GET['fld_bm_id']."'") or die(mysqli_error($connect)); 
		        ...
		        {
		            echo "<script>";
		            echo "alert('SC/ST Cell Update Successfully');";
		        ...
		        {
		            echo "<script>";
		            echo "alert('SC/ST Cell Not Update');";
		            echo "</script>";
		        }
		    }    
?>