		...
		<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
			<div class="min-height-200px">
				<div class="page-header">
					<div class="row">
						<div class="col-md-8 col-sm-12">
							<div class="title">
								<h4>Update Grievance Redressal Committee Members</h4>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                  					<li class="breadcrumb-item">Update Grievance Redressal Committee Members</li>
						...
						<div class="col-md-4 col-sm-12 text-right">
							<div class="dropdown">
								<a class="btn btn-primary" href="redressal_view.php" role="button">
									View Grievance Redressal Committee Members
								</a>
							</div>
						</div>
					</div>
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					...
					<form method="post">
                        <?php 
							$view=mysqli_query($connect,"select * from tbl_redressal_members where fld_bm_id='".$_GET['fld_bm_id']."'") or die(mysqli_error($connect));
						...
						<div class="form-group row">
							...
							<div class="col-sm-6">
                				...
                				<a href="redressal_view.php" class="btn btn-warning">Back</a>
							</div>
						</div>
					</form>
			</div>
...
<?php
    ...
    if (isset($_POST['submit'])) 
    {
        ...
        $add2=mysqli_query($connect,"update tbl_redressal_members set
        ...
        where fld_bm_id='".$_GET['fld_bm_id']."'") or die(mysqli_error($connect)); 
		        ...
		        {
		            echo "<script>";
		            echo "alert('Grievance Redressal Committee Members Update Successfully');";
		            echo "window.location.href='redressal_view.php';";
		            echo "</script>";                 
		        }
		        else
		        {
		            echo "<script>";
		            echo "alert('Grievance Redressal Committee Members Not Update');";
		            echo "</script>";
		        }
		    }    
?>