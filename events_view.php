				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>View Activities and Events </h4>
							</div>
					...
					<div class="row">
						...
						<table class="stripe hover data-table-export nowrap">
							...
							<tbody>
								<?php 
                                    $count=0; 
                                    $query="select t.*,d.* from tbl_events t,department d  where d.id=t.Department_id and t.fld_delete='0'  order by t.fld_gallery_id desc";
