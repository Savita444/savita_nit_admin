	...
	<div class="main-container">
		<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>Add Achievement Information</h4>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
									<!--<li class="breadcrumb-item"><a href="achievementsinfo_view.php">Achievement Information</a></li>-->
									<li class="breadcrumb-item active" aria-current="page">Add Achievement Information</li>
								</ol>
							</nav>
						</div>
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					...
					<form method="post" enctype="multipart/form-data">
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Achievement Title<span style="color: red;">*</span></label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" placeholder="Enter Title" name="achievement_title" required="">
							</div>
						</div>
            ...
            <div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<textarea class="textarea_editor form-control border-radius-0" name="achievement_description" placeholder="Enter Achievement Description"></textarea>
							</div>
						</div>
