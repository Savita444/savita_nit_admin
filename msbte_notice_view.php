        ...
        <div class="page-header">
          <div class="row">
            <div class="col-md-6 col-sm-12">
              <div class="title">
                <h4>View MSBTE Notice</h4>
              </div>
              <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                  <li class="breadcrumb-item">View MSBTE Notice</li>
            ...
            <div class="col-md-6 col-sm-12 text-right">
              <div class="dropdown">
                <a class="btn btn-primary" href="add_msbte_notice.php" role="button">
                  Add MSBTE Notice
                </a>
              </div>
            </div>
            ...
            <table class="stripe hover data-table-export nowrap">
              ...
              <tbody>
                <?php 
                  ...
                  $query = "SELECT * 
                  FROM msbte_notice WHERE msbte_notice_delete = '0' ORDER BY msbte_notice_id DESC"; // Specify s.id or d.id to resolve ambiguity
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="delete_msbte_notice.php?msbte_notice_id=<?php echo $fetch['msbte_notice_id'] ?>" onclick="return confirm('Are you sure to Delete MSBTE Notice Record')" class="fa fa-trash-o"  style="color: red;font-size: 20px;"></a>
