	...
	<div class="main-container">
		<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>Add Department Notice</h4>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
									<li class="breadcrumb-item active" aria-current="page">Add Department Notice</li>
								</ol>
							</nav>
						</div>
            ...
            <!--</div>						-->
                ...
                <div class="form-group row">
                    <label class="col-sm-12 col-md-2 col-form-label">Department Name<span style="color: red;">*</span></label>
                    <div class="col-sm-12 col-md-10">
                        <input name="department_name" type="text" Placeholder="Enter Department Name" class="form-control">
                    </div>
                </div>
...
// error_reporting(0);
  ...
  $extension = strtolower(pathinfo($a,PATHINFO_EXTENSION));  
               ...
               $query="insert into department_notice(title,department_name,notice,file) VALUES('$title','$department_name','$notice','$a');";
        ...
        if($add2)
       {
         ...
         echo " alert('Department Notice Added Successfully.');";
       ...
       {
         echo '<script type="text/javascript">';
         echo " alert('Department Notice Not Added.');";
         echo 'window.location.href = "department_notice_view.php";';
         echo '<script>';
       }
    }
