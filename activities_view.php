                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-2">
                            <a href="#" data-toggle="modal" data-target="#department_add" type="button"><button
                                    class="btn btn-primary">Add Activities</button></a>
                        </div>
                            ...
                            <form method="post">
                                <div class="modal-body">
                                    <div class="form-group row">
                                        <label class="col-sm-12 col-md-3 col-form-label">Activities Name<span
                                                class="text-danger">*</span> : </label>
                                        <div class="col-sm-12 col-md-9">
                                            <input class="form-control" type="text" name="activities" id="activities"
                                                placeholder="Enter Activities Name" required="" onkeyup="titleCase1()"
                                                onchange="titleCase1()"
                ...
                <?php
					...
					if (isset($_POST['submit'])) 
					{
						...
						else
						{
							...
							{
								echo "<script>";
								echo "alert('Activities Not Added');";
								echo "window.location.href='activities_view.php';";
								echo "</script>";
							}
						}    
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="#" data-toggle="modal"
                                            data-target="#activities_update<?php echo $fetch['activity_id'] ?>"
                                            title="Edit Activities"><i class="fa fa-pencil-square-o text-success"
                                                style="font-size: 20px"></i> </a>

                                        <a href="activities_trash.php?activity_id=<?php echo $fetch['activity_id'] ?>"
                                            onclick="return confirm('Are You Sure To Delete Activities Record')"
                                            title="Delete Activities"><i class="fa fa-trash text-danger"
                                    ...
                                    <div class="modal fade bs-example-modal-lg"
                                        id="activities_update<?php echo $fetch['activity_id'] ?>" tabindex="-1"
...
?>
                                                <form method="post"
                                                    action="activities_update.php?activity_id=<?php echo $fetch['activity_id'] ?>">
                                                    <div class="modal-body">
                                                        <div class="form-group row">
                                                            <label class="col-sm-12 col-md-3 col-form-label">Activities
                                                                Name<span class="text-danger">*</span> : </label>
                                                            <div class="col-sm-12 col-md-9">
                                                                <input class="form-control" type="text"
                                                                    name="activities" id="activities1"
                                                                    placeholder="Enter Activities Name" required=""
                                                                    value="<?php echo $view['activities'] ?>"
