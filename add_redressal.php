				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-8 col-sm-12">
							<div class="title">
								<h4>Add Grievance Redressal Committee Members</h4>
							</div>
...
<?php
	...
	$query="INSERT INTO tbl_redressal_members(fld_bm_name,Designation_id,mobilenumber,email) VALUES ('$fld_bm_name','$fld_bm_designation','$mobilenumber','$email')";
		        
		        $row=mysqli_query($connect,$query) or die(mysqli_error($connect));
		        if ($row) 
		        {
		            echo "<script>";
		            echo "alert('Grievance Redressal Committee Members Added Successfully');";
