			...
			<div class="min-height-200px">
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
                    ...
                    <?php 
                        ...
                        $view=mysqli_query($connect,"select * from event where event_id='".$_GET['event_id']."'") or die(mysqli_error($connect));
                    ...
                    <div class="form-group row">
                        ...
                        <div class="preview_box">
                                    <?php 
                                        ...
                                        { 
                                    ?>
                                        <img id="preview_img" src="assets/images/event/placeholder.jpg" height="100" width="100" />
                                    <?php 
                                        }
                                        else
                                        {
                                    ...
                                    ?>
                                        <img id="preview_img" src="assets/images/event/<?php echo $fetch['file']?>" height="100" width="100" />
                                    <?php 
                        ...
                        <!-- <input name="file" type="file"  accept="application/pdf"> -->
							...
							<div class="col-sm-6">
                                ...
                                <a href="event_view.php" class="btn btn-warning">Back</a>
							</div>
						</div>
					</form>
			</div>
...
if(isset($_POST['submit']))
{
    ...
    $desired_dir="assets/images/event/";
    move_uploaded_file($fileTmpName,"$desired_dir/".$a);

    if($add2)
   {
     echo '<script type="text/javascript">';
     echo " alert('Event Update Successfully.');";
     echo 'window.location.href = "event_view.php";';
     echo '</script>';
    }
    else
   {
     echo '<script type="text/javascript">';
     echo " alert('Event Not Update.');";
     echo 'window.location.href = "event_view.php";';
     echo '<script>';
   }
}
