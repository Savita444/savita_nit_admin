        ...
        <div class="page-header">
          <div class="row">
            ...
            <div class="col-md-6 col-sm-12 text-right">
              <div class="dropdown">
                <a class="btn btn-primary" href="add_medianews.php" role="button">
                  Add Media News
                </a>
              </div>
            </div>
          ...
          <div class="row">
            <table class="stripe hover data-table-export nowrap">
              ...
              <tbody>
                <?php 
                  $count=0; 
                  $query="select * from medianews  where syllabus_delete='0' order by media_id desc";
