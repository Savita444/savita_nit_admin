			...
			<div class="min-height-200px">
				<div class="page-header">
                  ...
                  <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
									<li class="breadcrumb-item">Curriculum Information</li>
									<li class="breadcrumb-item active" aria-current="page">Add Curriculum Information</li>
								</ol>
							</nav>
						</div>
...
// error_reporting(0);
  ...
  $extension = strtolower(pathinfo($a,PATHINFO_EXTENSION));  
        ...
        if($add2)
       {
         ...
         echo " alert('Curriculum Added Successfully.');";
       ...
       {
         echo '<script type="text/javascript">';
         echo " alert('Curriculum Information Not Added.');";
         echo 'window.location.href = "curriculuminfo_view.php";';
         echo '<script>';
       }
    }
