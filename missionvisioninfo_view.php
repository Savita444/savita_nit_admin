        ...
        <div class="page-header">
          <div class="row">
            <div class="col-md-6 col-sm-12">
              <div class="title">
                <h4>View Laboratories Information</h4>
              </div>
              <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                  <li class="breadcrumb-item"><a href="laboratoriesinfo_view.php">Laboratories Information</a></li>
                  <li class="breadcrumb-item active" aria-current="page">View Laboratories Information</li>
                </ol>
              </nav>
            </div>
            <div class="col-md-6 col-sm-12 text-right">
              <div class="dropdown">
                <a class="btn btn-primary" href="add_laboratories.php" role="button">
                  Add Laboratories Information
                </a>
              </div>
            </div>
          </div>
            ...
            <table class="stripe hover data-table-export nowrap">
              <thead>
                <tr>
                  ...
                  <th>laboratories Description</th>
                  <th>Image</th>
                  <th>Created Date</th>
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td><a href="../NIT/laboratories/<?php echo $fetch['photo'];?>" target="_blank"><img src="../NIT/laboratories/<?php echo $fetch['photo'];?>" height="75px" width="75px" ></a></td> 
