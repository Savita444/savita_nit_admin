			...
			<div class="min-height-200px">
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>Update Newsletters</h4>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
									<li class="breadcrumb-item">Update Newsletters</li>
								</ol>
							</nav>
						</div>
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
                    ...
                    <?php 
                        ...
                        $view=mysqli_query($connect,"select * from newsletters where newsletters_id='".$_GET['newsletters_id']."'") or die(mysqli_error($connect));
                    ...
                    <div class="form-group row">
                        ...
                        <div class="preview_box">
                                    <?php 
                                        ...
                                        { 
                                    ?>
                                        <img id="preview_img" src="assets/images/newsletters/.jpg" height="100" width="100" />
                                    <?php 
                                        }
                                        else
                                        {
                                    ...
                                    ?>
                                        <img id="preview_img" src="assets/images/newsletters/<?php echo $fetch['file']?>" height="100" width="100" />
                                    <?php 
...
if(isset($_POST['submit']))
{
    ...
    $add2=mysqli_query($connect,"update newsletters set
    Department_id='".$_POST['Department_id']."',
    file='".$a."'
    where newsletters_id='".$_GET['newsletters_id']."'") or die(mysqli_error($connect)); 
    ...
    if($add2)
   {
     ...
     echo " alert('Newsletters Update Successfully.');";
   ...
   {
     echo '<script type="text/javascript">';
     echo " alert('Newsletters Not Update.');";
     echo 'window.location.href = "newsletters_view.php";';
     echo '<script>';
   }
}
