	...
	<div class="main-container">
		<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>Add Laboratories Information</h4>
							</div>
            ...
            <div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<textarea class="textarea form-control border-radius-0" name="laboratories_description" placeholder="Enter Laboratories Description"></textarea>
							</div>
						</div>
...
// error_reporting(0);
    ...
    if(isset($_POST['submit']))
    {
        ...
        if($add2)
       {
         ...
         echo " alert('Laboratories Information Added Successfully.');";
       ...
       {
         echo '<script type="text/javascript">';
         echo " alert('Laboratories Information Not Added.');";
         echo 'window.location.href = "add_laboratories.php";';
         echo '<script>';
       }
    }
?>               
