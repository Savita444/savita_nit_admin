				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>Update CAP Round Process </h4>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
									<li class="breadcrumb-item">Update CAP Round Process</li>
								</ol>
							</nav>
						</div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="preview_box">
                                    <?php 
                                        ...
                                        { 
                                    ?>
                                        <img id="preview_img" src="assets/images/cap/placeholder.jpg" height="100" width="100" />
                                    <?php 
                                        }
                                        else
                                        {
                                    ...
                                    ?>
                                        <img id="preview_img" src="assets/images/cap/<?php echo $fetch['file']?>" height="100" width="100" />
                                    <?php 
...
if(isset($_POST['submit']))
{
    ...
    $add2=mysqli_query($connect,"update cap set
    file='".$a."'
    where cap_id='".$_GET['cap_id']."'") or die(mysqli_error($connect)); 
           
    $desired_dir="assets/images/cap/";
    move_uploaded_file($fileTmpName,"$desired_dir/".$a);

    if($add2)
   {
     echo '<script type="text/javascript">';
     echo " alert('CAP Round Process Update Successfully.');";
   ...
   {
     echo '<script type="text/javascript">';
     echo " alert('CAP Round Process Not Update.');";
     echo 'window.location.href = "cap_view.php";';
     echo '<script>';
   }
}
