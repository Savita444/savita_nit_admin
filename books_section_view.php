				...
				<div class="page-header">
					<div class="row">
						...
						<div class="col-md-6 col-sm-12 text-right">
							<div class="dropdown">
								<a class="btn btn-primary" href="add_books_section.php" role="button">
									ADD Books section
								</a>
							</div>
						</div>
						...
						<table class="stripe hover data-table-export nowrap">
							<thead>
								<tr>
                                    ...
                                    <th>Course Name</th>
                                    <th>Required As Per AICTE Norms</th>
                                    <th>Available</th>
                                    <th>Required As Per AICTE Norms</th>
                                    <th>Available</th>
                                    <th>Created Date</th>
							...
							<tbody>
								<?php 
                                    $count=0; 
                                    $query="select * from books_section where books_section_delete='0' order by books_section_id desc";
								...
								<tr>
									...
									<td><?php echo $fetch['aicte_norms'];?></td>
									<td><?php echo $fetch['available1'];?></td>
