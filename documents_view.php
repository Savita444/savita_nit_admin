				...
				<div class="page-header">
					<div class="row">
						...
						<div class="col-md-6 col-sm-12 text-right">
							<div class="dropdown">
								<a class="btn btn-primary" href="documents.php" role="button">
									Add Documents 
								</a>
							</div>
						</div>
					...
					<div class="row">
						<table class="stripe hover data-table-export nowrap">
							...
							<tbody>
								<?php 
                                $count=0; 
                                $query="select * from documents where fld_delete='0' order by documents_id desc";
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $fetch['documents_created_date'];?></td>   
                                </tr>
                                            <?php } ?>
							</tbody>
						</table>
