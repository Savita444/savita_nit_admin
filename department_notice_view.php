        ...
        <div class="page-header">
          <div class="row">
            <div class="col-md-6 col-sm-12">
              <div class="title">
                <h4>View Department Notice</h4>
              </div>
              <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                  <li class="breadcrumb-item">View Department Notice</li>
            ...
            <div class="col-md-6 col-sm-12 text-right">
              <div class="dropdown">
                <a class="btn btn-primary" href="add_department_notice.php" role="button">
            ...
            <table class="stripe hover data-table-export nowrap">
              ...
              <tbody>
                <?php 
                  ...
                  $query = "SELECT * 
                  FROM department_notice WHERE department_notice_delete = '0' ORDER BY department_notice_id DESC"; // Specify s.id or d.id to resolve ambiguity
