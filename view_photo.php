					...
					<div class="row">
						...
						<table class="stripe hover data-table-export nowrap">
							...
							<tbody>
								<?php 
                                    $count=0; 
                                    $query="select i.*,t.* from tbl_gallery_images i,tbl_gallery_image_title t where i.fld_image_title_id=t.fld_image_title_id and i.fld_delete='0' and t.fld_delete='0' order by i.	fld_gallery_id desc";
								...
								<tr>
									...
									<td>	
										...
										<a href="photo_delete.php?fld_gallery_id=<?php echo $fetch['fld_gallery_id'] ?>" onclick="return confirm('Are You Sure To Delete Photo')"><i class="fa fa-trash-o" style="color: red; font-size: 20px"></i></a>	
									</td>
