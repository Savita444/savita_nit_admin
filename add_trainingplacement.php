                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            ...
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">Add Training And Placement</li>
                        ...
                        <div class="col-md-6 col-sm-12 text-right">
                         <div class="dropdown">
                           <a class="btn btn-primary" href="academiccalendar_view.php" role="button">
                    ...
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <a href="academiccalendar_view.php" class="btn btn-warning">Back</a>
                            </div>
                        </div>
                    </form>
                </div>
