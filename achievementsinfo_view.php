        ...
        <div class="page-header">
          <div class="row">
            <div class="col-md-6 col-sm-12">
              <div class="title">
                <h4>View Achievement Information</h4>
              </div>
            ...
            <div class="col-md-6 col-sm-12 text-right">
              <div class="dropdown">
                <a class="btn btn-primary" href="add_achievement.php" role="button">
          ...
          <div class="row">
            <table class="stripe hover data-table-export nowrap">
              ...
              <tbody>
                <?php 
                  $count=0; 
                  $query="select * from tbl_achievement  where fld_delete='0' order by fld_achievement_id desc";
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="delete_achievementinfo.php?fld_achievement_id=<?php echo $fetch['fld_achievement_id'] ?>" onclick="refld_admin_idturn confirm('Are you sure to Achievement Information Record')" class="fa fa-trash-o"  style="color: red;font-size: 20px;"></a>
