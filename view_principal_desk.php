					...
					<div class="row">
						...
						<div class="col-md-6 col-sm-12 text-right">
							<div class="dropdown">
								...
								<?php 
                                            $count=0; 
                                            $query="select * from tbl_principal_desk where fld_delete='0' order by 		fld_principal_id desc";
								...
								<a class="btn btn-primary" href="add_principal_desk.php" role="button">
									Add Principal Desk
								</a>
							<?php } ?>
							</div>
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					...
					<div class="row">
						<table class="stripe hover data-table-export nowrap">
                            ...
                            <a href="principal_desk_delete.php?	fld_principal_id=<?php echo $fetch['fld_principal_id'] ?>" onclick="return confirm('Are you sure to Delete Principal Desk')" class="fa fa-trash-o"  style="color: red;font-size: 20px;"></a>
