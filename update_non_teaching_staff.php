...
<body>
	...
	<div class="main-container">
		<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>Update Non Teaching Staff</h4>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
									<li class="breadcrumb-item active" aria-current="page">Update Non Teaching Staff</li>
								</ol>
							</nav>
						</div>
            ...
            <?php 
                $sel=mysqli_query($connect,"select * from non_teaching_staff where non_teaching_staff_id='".$_GET['non_teaching_staff_id']."'") or die(mysqli_error($connect));
                $fetch=mysqli_fetch_array($sel);
              ?>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Name<span style="color: red;">*</span></label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" placeholder="Enter Name" name="name" required="" value="<?php echo $fetch['name'];?>">
							</div>
						</div>
            <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-12 col-md-10">
                <input class="form-control" type="text" placeholder="Enter Qualification" name="qualification" value="<?php echo $fetch['qualification'];?>">
              </div>
            </div>
            <div class="form-group row">
              <label class="col-sm-12 col-md-2 col-form-label">Experiance<span style="color: red;">*</span></label>
              <div class="col-sm-12 col-md-10">
                <input class="form-control" type="text" placeholder="Enter Experiance" name="experiance" value="<?php echo $fetch['experiance'];?>">
              </div>
            </div>
            <div class="form-group row">
              <label class="col-sm-12 col-md-2 col-form-label">Email<span style="color: red;">*</span></label>
              <div class="col-sm-12 col-md-10">
                <input class="form-control" type="email" placeholder="Enter Email" name="email" value="<?php echo $fetch['email'];?>">
              </div>
            </div>
            <div class="form-group row">
              <label class="col-sm-12 col-md-2 col-form-label">Mobile<span style="color: red;">*</span></label>
              <div class="col-sm-12 col-md-10">
                <input class="form-control" type="tel" maxlength="10" minlength="10" pattern="[789]{1}[0-9]{9}" placeholder="Enter Mobile" name="mobile" value="<?php echo $fetch['mobile'];?>">
              </div>
            </div>
						<div class="form-group row">
              ...
              <div class="col-sm-12 col-md-10">
                ...
                <div id="dvPreview">
                  <?php
                        ...
                        {
                    ?>
                            <img src="assets/images/non_teaching_staff/No-image-full.jpg" alt="John Doe" id="preview_img" height="100px" width="100px"/>
                    <?php
                        }
                        else
                        {
                    ?>                                        
                            <img src="assets/images/non_teaching_staff/<?php echo $fetch['photo'];?>" alt="John Doe" id="preview_img" height="100px" width="100px" />
                    <?php
                        }
                    ?>
                </div>
    ...
    if(isset($_POST['update']))
    {
        ...
        if(isset($_FILES['files'])){
            ...
            foreach($_FILES['files']['tmp_name'] as $key => $tmp_name ){
                ...
                // }       
                $query=mysqli_query($connect,"update non_teaching_staff set
                name='".$name."', 
                ...
                mobile='".$mobile."',
                photo='".$a."'
                where non_teaching_staff_id='".$_GET['non_teaching_staff_id']."'") or die(mysqli_error($connect));
        ...
        if($query)
       {
         ...
         echo " alert('Non Teaching Staff Details Deleted.');";
       ...
       {
         echo '<script type="text/javascript">';
         echo " alert('Non Teaching Staff Details not Deleted.');";
         echo 'window.location.href = "view_non_teaching_staff.php";';
         echo '<script>';
       }
    }
