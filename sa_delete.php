...
$delete1 = mysqli_query($connect,"Update tbl_sa_members set fld_delete='1' where fld_bm_id='".$_GET['fld_bm_id']."'")or die(mysqli_error($connect));
...
$back="sainfo_view.php";
  if($delete1)

          {
            echo '<script type="text/javascript">';
            echo "alert('Students Association Members deleted');";
          ...
          {
            echo '<script type="text/javascript">';
            echo "alert('Students Association Members  not deleted');";
            echo 'window.location.href = "'.$back.'"';
            echo "</script>";
