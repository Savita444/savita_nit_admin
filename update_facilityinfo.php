...
<body>
	...
	<div class="main-container">
		<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>Update Facility Information</h4>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
									<li class="breadcrumb-item"><a href="facilitiesinfo_view.php">Facility Information</a></li>
									<li class="breadcrumb-item active" aria-current="page">Update Facility Information</li>
								</ol>
							</nav>
						</div>
            ...
            <?php 
                $sel=mysqli_query($connect,"select * from tbl_facility where fld_facility_id='".$_GET['fld_facility_id']."'") or die(mysqli_error($connect));
                    ...
                    <option value="">Select Facility</option>
                        <?php
                            ...
                            while($row=mysqli_fetch_assoc($query1)){
                              extract($row);
                          ?>
                    <option value="<?php echo $row['facility_id'];?>" <?php if ($fetch['facility_id']==$row['facility_id']){echo "selected";} ?>><?php echo $row['facility'];?></option>
                    <?php  }?>
                 </select>
              </div>
            </div>
