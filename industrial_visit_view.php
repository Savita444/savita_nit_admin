				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>View Industrial visit and mentor meeting</h4>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
									<li class="breadcrumb-item">View Industrial visit and mentor meeting</li>
						...
						<div class="col-md-6 col-sm-12 text-right">
							<div class="dropdown">
								<a class="btn btn-primary" href="add_industrial_visit.php" role="button">
									Add Industrial visit and mentor meeting
								</a>
							</div>
						</div>
					</div>
						...
						<table class="stripe hover data-table-export nowrap">
							<thead>
								<tr>
									...
									<th>Industrial visit and mentor meeting</th>
									<th>Created Date</th>
								</tr>
							</thead>
							<tbody>
								<?php 
                                $count=0; 
                                $query="select * from industrial_visit where industrial_visit_delete='0' order by industrial_visit_id desc";
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $fetch['industrial_visit_created_date'];?></td>   
                                </tr>
                                            <?php } ?>
							</tbody>
						</table>
