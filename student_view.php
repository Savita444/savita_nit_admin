				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>View Student Download Section</h4>
							</div>
						...
						<div class="col-md-6 col-sm-12 text-right">
							<div class="dropdown">
								<a class="btn btn-primary" href="add_student.php" role="button">
									Add Student Download Section
								</a>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<table class="stripe hover data-table-export nowrap">
							...
							<tbody>
								<?php 
                                $count=0; 
                                $query="select * from student_download where fld_delete='0' order by student_id desc";
