        ...
        <div class="page-header">
          <div class="row">
            <div class="col-md-6 col-sm-12">
              <div class="title">
                <h4>View Time Table Information</h4>
              </div>
            ...
            <div class="col-md-6 col-sm-12 text-right">
              <div class="dropdown">
                <a class="btn btn-primary" href="add_timetable.php" role="button">
          ...
          <div class="row">
            <table class="stripe hover data-table-export nowrap">
              ...
              <tbody>
                <?php 
                  $count=0; 
                  $query="select s.*,d.* from timetable s,department d  where s.department_id=d.id and syllabus_delete='0' order by timetable_id desc";
                ...
                <tr>
                    ...
                    <!--<td><?php echo $fetch['year'];?></td>-->
                     ...
                     <td><a href="assets/images/timetable/<?php echo $fetch['file'];?>" class="btn btn-small btn-primary">
